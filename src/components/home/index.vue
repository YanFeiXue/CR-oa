    ...
    data() {
      return {
        ...
        dailyWorkList: [{
            title: '日常工作',
            list: [{
                icon: '../../assets/img/GZJH.png',
                content: '工作计划',
                router: '/pageMain/work-plan'
              },
              {
                icon: '../../assets/img/PRRB.png',
                content: 'PR日报',
                router: '/pageMain/look-log'
              },
              {
                icon: '../../assets/img/MRQD.png',
                content: '每日签到',
                router: ''
              },
              {
                icon: '../../assets/img/TDJH.png',
                content: '团队计划',
                router: ''
              }
            ]
          },
          {
            title: '经销商信息',
            list: [{
                icon: '../../assets/img/YSPJL.png',
                content: '预审批记录',
                router: '/pageMain/approval-record'
              },
              {
                icon: '../../assets/img/ZTCX.png',
                content: '状态查询',
                router: '/pageMain/state-select'
              },
              {
                icon: '../../assets/img/ZTJJ.png',
                content: '暂停进件',
                router: ''
              },
              {
                icon: '../../assets/img/ZTFK.png',
                content: '暂停放款',
                router: ''
              }
            ]
          },
          {
            title: '数据中心',
            list: [{
                icon: '../../assets/img/XSBB.png',
                content: '销售报表',
                router: ''
              },
              {
                icon: '../../assets/img/ZHL.png',
                content: '转化率',
                router: ''
              },
              {
                icon: '../../assets/img/XSRW.png',
                content: '销售任务',
                router: ''
              },
              {
                icon: '../../assets/img/BB.png',
                content: '报表',
                router: ''
              }
            ]
