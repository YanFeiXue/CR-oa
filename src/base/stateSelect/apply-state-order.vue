...
Vue.use(Cell)
  .use(Field)
  .use(ActionSheet)
import { getProcessList, xrtxGetProcessList } from '@/api/api'
  ...
  data() {
    return {
      ...
      option: [
        ...
        { value: 5, name: '终审' },
        { value: 6, name: '签约准备' },
        { value: 7, name: '等待GPS安装' },
        { value: 8, name: '放款资料待提交' },
        { value: 9, name: '放款资料审核' },
        { value: 10, name: '放款' },
        { value: 11, name: '资料回寄' },
        { value: 12, name: '资料归档' },
